"""Native Algotradify trading runtime entrypoint.

Promoted from the imported Tradebot runtime snapshot in Runtime Correction PR 5.
This file starts the native trading runtime directly. It does not dynamically load
another repository's main.py.
"""
