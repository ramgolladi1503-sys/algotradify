...
from api.server_with_dry_run import app
...
def test_dry_run_execution_exists_on_mounted_app(tmp_path, monkeypatch):
...
def test_dry_run_execution_mounted_app_blocks_by_default(tmp_path, monkeypatch):
    import api.server as server
...
def test_dry_run_execution_mounted_app_creates_with_seeded_runtime(tmp_path, monkeypatch):
    import api.server as server
...
def test_dry_run_execution_mounted_app_append_false_writes_nothing(tmp_path, monkeypatch):
    import api.server as server
...
def test_dry_run_execution_mounted_app_append_true_writes_jsonl(tmp_path, monkeypatch):
    import api.server as server
